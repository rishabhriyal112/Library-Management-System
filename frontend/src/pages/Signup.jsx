...
function Signup() {
    ...
    //It will show the toast for 2.6 seconds
    useEffect(() => {
                    ...
                    <div className={s.formInner}>
                        ...
                        <form className={s.form} onSubmit={handleSubmit}>
                            {step === 1 && (
                                <>
                                    <label className="block">
                                        ...
                                        <input type="text" name='name' value={form.value} onChange={handleChange} placeholder='Enter your full name' className={s.input} />
                                    </label>
                                    ...
                                    <label className="block">
                                        ...
                                        <div className={s.passwordWrapper}>
                                            ...
                                            <button type='button' onClick={() => setShowPassword((current) => !current)} className={s.toggleButton}>
                            ...
                            <div className={s.buttonGroup}>
                                {
                                    step > 1 && (
                                        <button type='button' onClick={goBack} disabled={loading} className={s.backButton}>Back</button>
                                    )
                                }
