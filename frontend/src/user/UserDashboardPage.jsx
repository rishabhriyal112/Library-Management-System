...
import { AlertTriangle, BookCopy, GraduationCap, GraduationCapIcon, IdCard, ReceiptText, Sparkles } from 'lucide-react'
    ...
    <div className={s.pageContainer}>
        ...
        <div className={s.heroGrid}>
          <div className={s.heroLeft}>
            ...
            <p className={s.heroText}>
              Your dashboard now keeps the important account summary at the top and show the most recent issued books directly below for faster access.
            </p>
          </div>
      ...
      <section className={s.statsGrid}>
        {
          overviewStats.map((item)=>{
            ...
            return(
              <article key={item.icon} className={s.statCard}>
      ...
      <section className={s.recentSection}>
        <div className={s.recentHeader}>
          ...
          <Link to="/user/books" className={s.viewMoreButton}>View More</Link>
        </div>
        ...
        <div className={s.recentGrid}>
          {
            recentBooks.length ? (
              ...
              <div className={s.emptyRecentState}>No recent books found for this account.</div>
            )
          }
        </div>
      </section>
