            ...
            <section className={s.mainSection}>
                <div className={s.headerFlex}>
                    <div>
                        ...
                        <p className={s.subtitle}>Update your student details and save the latest profile information.</p>
                    </div>

                    {
                        !isEditing && (
                            <button type='button' onClick={() => setIsEditing(true)}><Pencil size={18} /> </button>
                        )
                    }
                </div>
